...
---@alias _keygrabber_signals
---| "'property::current_instance'" # The global signal used to track the [current_instance](awful.keygrabber.current_instance).
---| "'started'" # When the keygrabber starts.
---| "'stopped'" # When the keygrabber stops.
---| "'keybinding::triggered'" # When an [awful.key](awful.key) is pressed.
...
---@alias _screenshot_signals
---| "'snipping::start'" # Emitted when the interactive snipping starts.
---| "'snipping::success'" # Emitted when the interactive snipping succeeds.
...
---| "'file::saved'" # Emitted when the screenshot is saved.
